<?php
/* 
 * EJuiAutoCompleteFkField class file - renamed to JuiAutoCompleteFk
 * see http://www.yiiframework.com/extension/ejui-autocomplete-fk-field/ for more information
 *
 * @author Jeremy Dunn <jeremy.j.dunn@gmail.com>
 * @link http://www.yiiframework.com/
 * @version 1.1 - 21 March 2011
 * 
 * Adapted for Parallel by Anton Menkveld
 * 
 * Adapted for use with Twitter Bootstrap sites.
 */
...
class JuiBSAutoCompleteFk extends JuiAutoComplete {
	...
	/**
	 * Show the delete icon or not. If this field is required, typically you will not show the delete icon,
	 * so set this to true.
	 * @var unknown_type
	 */
	...
	/**
	 * Tooltip to be shown over remove icon. Only applicable if noDelete = false
	 * @var unknown_type
	 */
	public $deleteTooltip = "Remove item";
    ...
    public function run() {
		...
		if(!$this->noDelete) {
			echo "&nbsp;<a href='#' rel='tooltip' title='".$this->deleteTooltip."'><i class='icon-remove-sign' id='".$this->_fieldName."_delete_icon'></i></a>";
			\Yii::app()->clientScript->registerScript(
						$this->_fieldName."_delete_script",
						"$('#".$this->_fieldName."_delete_icon"."').click(function() { 
																				$('#".$this->_fieldName."').val('');$('#".$this->_saveName."').val('');$('#".$this->_lookupName."').val('');
																			});",
